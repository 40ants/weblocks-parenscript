# -*- coding: utf-8 -*-
#
# weblocks-parenscript documentation build configuration file, created by
...
cl_systems = [
    {
        'name': 'weblocks-parenscript-test',
...
project = u'weblocks-parenscript'
copyright = u'2017, '
...
htmlhelp_basename = 'weblocks-parenscriptdoc'
...
latex_documents = [
  ('index', 'weblocks-parenscript.tex', u'weblocks-parenscript Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'weblocks-parenscript', u'weblocks-parenscript Documentation',
     [u''], 1)
]
